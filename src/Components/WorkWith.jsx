...
function WorkWith() {
  ...
  return (
    <div className="rounded mt-3 shadow px-4 py-3 d-flex flex-column con3">
      ...
      <button className="btn btn-primary primaryBg fw-bold text-white mt-2" onClick={handleClick}>Let's Talk</button>
    </div>
  );
}

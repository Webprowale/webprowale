  ...
  return (
    <div className="rounded shadow px-3 pt-2 d-flex flex-column mt-2 con1" ref={con}>
      ...
      <p className="text-start mt-2">
        Here’s a curated selection of real-world projects I’ve worked on — from AI-powered transcription apps and full-scale admin dashboards to modern company websites and service platforms. Each solution reflects my strength in delivering high-quality web experiences using cutting-edge technologies like <strong>React</strong>, <strong>Next.js</strong>, <strong>Node.js</strong>, <strong>NestJS</strong>, and <strong>Laravel/CodeIgniter</strong>. Whether it's crafting intuitive frontends or developing secure and scalable backend APIs (REST & GraphQL), I focus on building tools that drive real value for businesses and users alike.
      </p>
      ...
      <div className="d-flex flex-column">
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://www.sonicnota.com/">
            ...
            <p>
              AI wrapper that generates transcripts from your voice recordings using Whisper on Replicate and summarizes them.
            </p>
            <div className="mt-1">
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://nymous-app.netlify.app/">
            ...
            <p>
              An interactive anonymous messaging platform with a dare game.
            </p>
            <div className="mt-1">
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://pikup-control.vercel.app/">
            ...
            <p>
              Fully functional admin dashboard built with Next.js to monitor and manage app activities.
            </p>
            <div className="mt-1">
              <span className="badge bg-dark me-1">Next.js</span>
              <span className="badge bg-primary me-1">Node.js</span>
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://pikup-six.vercel.app/">
            ...
            <p>
              A waitlist landing page for Pikup built to capture early access users.
            </p>
            <div className="mt-1">
              <span className="badge bg-dark me-1">Next.js</span>
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://dancefitltd.co.uk/">
            ...
            <p>
              A company website offering dance classes as a service.
            </p>
            <div className="mt-1">
              <span className="badge bg-dark me-1">React</span>
        ...
        <div className="rounded shadow p-2 mb-2">
          <Link target="_blank" to="https://losungconsult.com/">
            ...
            <p>
              Corporate consulting company site for showcasing services.
            </p>
            <div className="mt-1">
